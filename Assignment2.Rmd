...
- \textcolor{red}{Problem 1}: Choose a $3-by-3$ covariance matrix with non-zero covariances (the off-diagonal elements should not be 0). Using the covariance matrix you chose, simulate 1,000 data sets from a trivariate normal distribution (set also n=1000).  
  0. Hints: 
