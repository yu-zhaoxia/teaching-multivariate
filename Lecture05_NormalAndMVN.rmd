...
- Clearly $\bar {\mathbf X}$ and $\mathbb C$ are linear combinations of $\mathbf X$, which follows a multivariate normal with covariance $\boldsymbol\Sigma= \mathbf I$. Thus, 
